...
public class App extends Application{
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        autos = Serializacao.leSerializadoAutos();
        abastecimentos = Serializacao.leSerializadoAbasts();
        ...
        Serializacao.serializaAutos(autos);
        Serializacao.serializaAbasts(abastecimentos);
    }
